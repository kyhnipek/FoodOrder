...
public class DataGenerator
{
    ...
    {
        using (var context = new FoodOrderDBContext(serviceProvider.GetRequiredService<DbContextOptions<FoodOrderDBContext>>()))
        {
            ...
            AddFoods(context);
            AddRestaurants(context);
            AddUsers(context);
            AddCouriers(context);
            AddQuantities(context);
            AddOrders(context);

        };
    }
    public static void AddFoods(FoodOrderDBContext context)
    {
    ...
    public static void AddRestaurants(FoodOrderDBContext context)
    {
    ...
    public static void AddUsers(FoodOrderDBContext context)
    {
    ...
    public static void AddCouriers(FoodOrderDBContext context)
    {
    ...
    public static void AddQuantities(FoodOrderDBContext context)
    {
    ...
    public static void AddOrders(FoodOrderDBContext context)
    {
